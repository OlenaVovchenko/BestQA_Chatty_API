...
TestEx case 1: Verify post can be deleted 
Feature: Delete Post
...
TestEx Case 2: Verify error on deleting post with invalid id
...
TestEx Case 3: Verify unauthorized error on deleting post without authentication
Feature: Delete Post
